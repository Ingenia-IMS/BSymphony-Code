...
static void hw_select_face(ir_face_t face)
{
    ...
    /*
     * Mapeo binario normal:
     * face 0 -> SEL0=0 SEL1=0
     * face 1 -> SEL0=1 SEL1=0   // coincide con tu main de prueba
     * face 2 -> SEL0=0 SEL1=1
     * face 3 -> SEL0=1 SEL1=1
     */
...
/*
 * Emite beacon y escucha en los huecos y al final.
 * Así reducimos auto-detección mientras el propio TX está encendido.
 */
static bool signal_send_beacon_and_detect(uint32_t slot_us)
{
